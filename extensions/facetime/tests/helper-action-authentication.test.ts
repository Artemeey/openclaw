...
describe("FaceTime helper connection authentication", () => {
  it(
    "requires mutual proof and rejects signed action replay across a connection epoch",
    { timeout: 20_000 },
    () => {
      ...
      try {
        ...
        execFileSync("/usr/bin/clang", [
          ...
          "-framework",
          "Security",
          path.join(packageRoot, "helper/FaceTimeHelper/ConnectionAuthentication.m"),
          path.join(packageRoot, "helper/tests/ConnectionAuthenticationTests.m"),
          "-o",
          binary,
        ]);
