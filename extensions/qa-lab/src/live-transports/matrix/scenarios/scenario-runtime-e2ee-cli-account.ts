...
export async function runMatrixQaE2eeCliEncryptionSetupBootstrapFailureScenario(
  ...
  try {
    ...
    if (failures.length > 1) {
      // oxlint 1.78 checks argument 2, but AggregateError takes cause in argument 3.
      // eslint-disable-next-line preserve-caught-error -- The caught error is preserved below.
