...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["exec.approval.grants.list", null, "operator.approvals", "2026.9"],
  ["exec.approval.grants.revoke", null, "operator.approvals", "2026.9"],
  ...
  ["sessions.goal.update", "sessions-goal", "operator.write", "2026.9"],
  ["sessions.goal.clear", "sessions-goal", "operator.write", "2026.9"],
  ...
  ["plugins.inspect", "plugins", "operator.read", "2026.9"],
