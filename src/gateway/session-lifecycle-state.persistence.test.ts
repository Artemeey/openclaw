...
it.each([
  { phase: "end", data: {}, status: "done" },
  { phase: "error", data: { aborted: true, stopReason: "aborted" }, status: "killed" },
])(
  "keeps an owner claim active until its queued $phase write commits",
