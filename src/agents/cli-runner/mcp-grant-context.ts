...
export function buildCliMcpGrantContext(params: {
  ...
  return {
    ...
    ...(params.run.skillWorkshopProposalRevision || params.run.skillLibraryAuthoring
      ? {
          skillWorkshop: {
            proposalRevision: params.run.skillWorkshopProposalRevision,
            libraryAuthoring: params.run.skillLibraryAuthoring,
          },
        }
      : {}),
