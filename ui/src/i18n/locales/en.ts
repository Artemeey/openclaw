...
export const en: TranslationMap = {
  ...
  modelProviders: {
    ...
    profiles: {
      ...
      configPinnedHint: "profile pinned in config",
      useAutomatic: "Use automatic rotation",
      useConfigured: "Use configured order",
      useInherited: "Use inherited order",
      include: "Include",
      ...
      cliManaged: "CLI managed",
      reorder: "Reorder {account}, currently priority {position}",
      moved: "Moved {account} to priority {position}",
      automaticFor: "{account}, automatic rotation",
      pinnedFor: "{account}, profile pinned in config",
