  ...
  it.each([
    {
      ...
      props: { loading: true },
      present: { 'openclaw-panel-loading-skeleton[data-panel-skeleton="chat"]': null },
      absent: [".agent-chat__welcome"],
      counts: { 'openclaw-panel-loading-skeleton[data-panel-skeleton="chat"]': 1 },
    },
    {
    ...
    },
    {
      ...
      absent: ['openclaw-panel-loading-skeleton[data-panel-skeleton="chat"]'],
    },
    {
